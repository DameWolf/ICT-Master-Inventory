...
import bgExtended from "../assets/hero_it_extended_rectangular.png";
import "./HomePage.css";
...
export default function HomePage({
  ...
  // Track mouse coordinates for interactive 3D parallax & spotlight glow
  ...
  return (
    ...
    >
      {/* ── Extended Rectangular 3D IT Background Wallpaper ── */}
      <div className="home-bg-illustration-layer">
        <img
          src={bgExtended}
          alt="Extended 3D IT Infrastructure Background"
          className="bg-it-img-full"
        />
      ...
      {/* ── Interactive 12 Categories Grid Section ── */}
